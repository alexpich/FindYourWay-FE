...
@Component({
  selector: 'app-question-a-c-b',
  templateUrl: './question-a-c-b.component.html',
  styleUrls: ['./question-a-c-b.component.css']
})
export class QuestionACBComponent implements OnInit {
  ...
  private type = 'type=museum';
  private keyword = 'keyword=museum';
