...
@Component({
  selector: 'app-question-a-b-a',
  templateUrl: './question-a-b-a.component.html',
  styleUrls: ['./question-a-b-a.component.css']
})
export class QuestionABAComponent implements OnInit {
  ...
  private type = 'type=gym';
  private keyword = 'sports';
